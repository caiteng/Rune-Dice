...
export function createState(seed:number):GameState{return{seed,phase:'battle',battleIndex:0,player:{maxHp:40,hp:40,armor:0,gold:0,rerollMax:2,rerollsLeft:2,relics:[],runeBonus:{}},enemy:createEnemy(0),dice:makeDice(5),log:['战斗开始'],pendingRewards:[],pendingDieUpgrade:null}}
